...
const grammar: Grammar = {
  ...
  ParserRules: [
    { name: 'main', symbols: ['LogicalExpression'], postprocess: id },
    {
      ...
      symbols: ['LogicalExpression', '_', { literal: '||' }, '_', 'LogicalExpression'],
      postprocess: convertLogicalExpression,
    },
    {
      name: 'LogicalExpression',
      symbols: ['LogicalExpression', '_', { literal: '&&' }, '_', 'LogicalExpression'],
    ...
    {
      name: 'P',
      symbols: [{ literal: '(' }, '_', 'LogicalExpression', '_', { literal: ')' }],
      postprocess: (d) => d[2],
    },
    {
      name: 'P',
      symbols: [{ literal: '(' }, '_', 'BinaryExpression', '_', { literal: ')' }],
      postprocess: (d) => d[2],
    },
    {
    ...
    },
    {
      ...
      symbols: ['BinaryOperand', '_', 'BinaryOperator', '_', 'BinaryOperand'],
      postprocess: convertBinaryExpression,
    },
    ...
    {
      name: 'MathFunctionParams',
      symbols: ['MathFunctionParams', '_', { literal: ',' }, '_', 'MathFunctionParameter'],
      postprocess: (d) => d[0].concat(d[4]),
    },
    {
      name: 'FunctionCall',
      symbols: [{ literal: 'sum' }, '_', { literal: '(' }, '_', 'MathFunctionParams', '_', { literal: ')' }],
      postprocess: convertFunctionExpression,
    },
    {
      name: 'FunctionCall',
      symbols: [
    ...
    {
      name: 'FunctionCall',
      symbols: [{ literal: 'max' }, '_', { literal: '(' }, '_', 'MathFunctionParams', '_', { literal: ')' }],
      postprocess: convertFunctionExpression,
    },
    {
      name: 'FunctionCall',
      symbols: [{ literal: 'min' }, '_', { literal: '(' }, '_', 'MathFunctionParams', '_', { literal: ')' }],
      postprocess: convertFunctionExpression,
    },
    {
      name: 'FunctionCall',
    ...
    {
      name: 'ParameterList',
      symbols: ['ParameterList', '_', { literal: ',' }, '_', 'ListOperand'],
      postprocess: (d) => d[0].concat(d[4]),
    },
    {
      name: 'Variable',
      symbols: [lexer.has('Variable') ? { type: 'Variable' } : Variable],
      postprocess: convertVariable,
    },
    {
      name: 'NumberLiteral',
      symbols: [{ literal: '-' }, lexer.has('NumberLiteral') ? { type: 'NumberLiteral' } : NumberLiteral],
      postprocess: (d) => convertSignedNumber('-', d[1]),
    },
    {
      name: 'NumberLiteral',
      symbols: [{ literal: '+' }, lexer.has('NumberLiteral') ? { type: 'NumberLiteral' } : NumberLiteral],
      postprocess: (d) => convertTokenId([d[1]]),
    },
    {
      name: 'NumberLiteral',
    ...
    },
    {
      ...
      symbols: [lexer.has('LogicalOperator') ? { type: 'LogicalOperator' } : LogicalOperator],
      postprocess: convertOperator,
    },
    {
      name: 'CollectionOperator',
      symbols: [lexer.has('CollectionOperator') ? { type: 'CollectionOperator' } : CollectionOperator],
      postprocess: convertOperator,
    },
    {
      name: 'BinaryOperator',
      symbols: [lexer.has('BinaryOperator') ? { type: 'BinaryOperator' } : BinaryOperator],
      postprocess: convertOperator,
    },
    {
      name: 'AddSubOperator',
      symbols: [lexer.has('AddSubOperator') ? { type: 'AddSubOperator' } : AddSubOperator],
      postprocess: convertOperator,
    },
    {
      name: 'MDOperator',
      symbols: [lexer.has('MDOperator') ? { type: 'MDOperator' } : MDOperator],
      postprocess: convertOperator,
    },
    {
      name: 'EXPOperator',
      symbols: [lexer.has('EXPOperator') ? { type: 'EXPOperator' } : EXPOperator],
      postprocess: convertOperator,
    },
