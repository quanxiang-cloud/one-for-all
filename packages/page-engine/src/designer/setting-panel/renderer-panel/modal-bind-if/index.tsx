...
function ModalBindIf({ onClose }: Props): JSX.Element | null {
  ...
  useEffect(()=> {
    setStateExpr(get(page.activeElem, '_renderer.if'));
  }, []);
  ...
  function handleBind(): void {
    ...
    page.updateElemProperty(page.activeElem.id, '_renderer.if', stateExpr);
    onClose(false);
  }
...
export default observer(ModalBindIf);
