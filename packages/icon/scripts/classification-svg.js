...
function classificationByFill(svgArr, dropSingleColor) {
  ...
  svgArr.forEach((svgCode) => {
    ...
    // The effectiveFillValue.length represents the number of valid color values（1: single color，2:double color，>2:multi color）
...
function uniteFillColor(svgArr) {
  return classificationByFill(svgArr, true);
}
